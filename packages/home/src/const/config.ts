export const DISCORD_URL = "https://discord.com/invite/9VTzKygcBG";
export const GITHUB_URL = "https://github.com/TWiDAOs/TWiDAOs";
export const TWITTER_URL = "https://twitter.com/TWiDAOs";
export const ANCHOR_URL = "https://anchor.fm/twidaos";
